	...
	*/
	...
	{  
		...
		if (mag >= 5) {
			...
			marker.setRadius(THRESHOLD_MODERATE);
		} else {
			marker.setColor(blue);
			marker.setRadius(THRESHOLD_LIGHT);
		}
	...
	{	
		...
		fill(color(250,250,120));
		rect(10, 120, 170, 200, 7);
		String s1 = "EarthqukeLIVE";
		fill(color(150,150,150));
		textSize(26);
		text(s1, 10, 10, 130, 200);		
		String s2 = "By FuHao";
		textSize(20);
		text(s2, 10, 80, 130, 200); 
		
		fill(color(255, 0, 0));
		ellipse(30, 175, 15, 15);
